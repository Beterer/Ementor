...
namespace Ementor.Tests.Sessions
{
    public abstract class EmentorTestBase : AbpIntegratedTestBase
    {
        protected EmentorTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<EmentorApplicationModule>();
            modules.Add<EmentorDataModule>();
        }

        public void UsingDbContext(Action<EmentorDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<EmentorDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<EmentorDbContext, T> func)
        {
            T result;
